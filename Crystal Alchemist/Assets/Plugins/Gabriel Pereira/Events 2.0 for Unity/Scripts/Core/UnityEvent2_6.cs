...
{
	public delegate void UnityAction<T1, T2, T3, T4, T5, T6>(T1 arg0, T2 arg1, T3 arg2, T4 arg3, T5 arg4, T6 arg5);

	/// <summary>
	/// Events 2.0 for Unity with five generic types
	/// </summary>
	[Serializable]
	public abstract class UnityEvent2<T1, T2, T3, T4, T5, T6> : UnityEventBase2
	{
		...
		public void AddListener(UnityAction<T1, T2, T3, T4, T5, T6> call)
		{
		...
		/// </summary>
		/// <param name="call">Callback function.</param>
		public void RemoveListener(UnityAction<T1, T2, T3, T4, T5, T6> call)
		{
		...
		{
			return GetValidMethodInfo(targetObj, name, new Type[6] { typeof(T1), typeof(T2), typeof(T3), typeof(T4), typeof(T5), typeof(T6) });
		}
		...
		private static BaseInvokableCall2 GetDelegate(UnityAction<T1, T2, T3, T4, T5, T6> action)
		{
			return new InvokableCall2<T1, T2, T3, T4, T5, T6>(action);
		}
		...
		{
			List<BaseInvokableCall2> calls = PrepareInvoke(arg1, arg2, arg3, arg4, arg5, arg6);
			for (var i = 0; i < calls.Count; i++)
			{
				var curCall = calls[i] as InvokableCall2<T1, T2, T3, T4, T5, T6>;
				if (curCall != null)
		...
		internal void AddPersistentListener(UnityAction<T1, T2, T3, T4, T5, T6> call)
		{
			AddPersistentListener(call, UnityEventCallState.RuntimeOnly);
		}

		internal void AddPersistentListener(UnityAction<T1, T2, T3, T4, T5, T6> call, UnityEventCallState callState)
		{
		...
		internal void RegisterPersistentListener(int index, UnityAction<T1, T2, T3, T4, T5, T6> call)
		{
			if (call == null)
