...
{
	public delegate void UnityAction<T1, T2, T3, T4, T5, T6, T7, T8>(T1 arg0, T2 arg1, T3 arg2, T4 arg3, T5 arg4, T6 arg5, T7 arg6, T8 arg7);

	/// <summary>
	/// Events 2.0 for Unity with five generic types
	/// </summary>
	[Serializable]
	public abstract class UnityEvent2<T1, T2, T3, T4, T5, T6, T7, T8> : UnityEventBase2
	{
		...
		public void AddListener(UnityAction<T1, T2, T3, T4, T5, T6, T7, T8> call)
		{
		...
		/// </summary>
		/// <param name="call">Callback function.</param>
		public void RemoveListener(UnityAction<T1, T2, T3, T4, T5, T6, T7, T8> call)
		{
		...
		{
			return GetValidMethodInfo(targetObj, name, new Type[8] { typeof(T1), typeof(T2), typeof(T3), typeof(T4), typeof(T5), typeof(T6), typeof(T7), typeof(T8) });
		}

		internal override BaseInvokableCall2 GetDelegate(object target, MethodInfo theFunction)
		{
			return new InvokableCall2<T1, T2, T3, T4, T5, T6, T7, T8>(target, theFunction);
		}

		private static BaseInvokableCall2 GetDelegate(UnityAction<T1, T2, T3, T4, T5, T6, T7, T8> action)
		{
			return new InvokableCall2<T1, T2, T3, T4, T5, T6, T7, T8>(action);
		}
		...
		{
			List<BaseInvokableCall2> calls = PrepareInvoke(arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8);
			for (var i = 0; i < calls.Count; i++)
			{
				var curCall = calls[i] as InvokableCall2<T1, T2, T3, T4, T5, T6, T7, T8>;
				if (curCall != null)
		...
		internal void AddPersistentListener(UnityAction<T1, T2, T3, T4, T5, T6, T7, T8> call)
		{
			AddPersistentListener(call, UnityEventCallState.RuntimeOnly);
		}

		internal void AddPersistentListener(UnityAction<T1, T2, T3, T4, T5, T6, T7, T8> call, UnityEventCallState callState)
		{
		...
		internal void RegisterPersistentListener(int index, UnityAction<T1, T2, T3, T4, T5, T6, T7, T8> call)
		{
			if (call == null)
